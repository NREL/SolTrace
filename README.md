# SolTrace
![Build](https://github.com/NREL/SolTrace/actions/workflows/CI.yml/badge.svg)[![Coverage Status](https://coveralls.io/repos/github/NREL/SolTrace/badge.svg?branch=coveralls)](https://coveralls.io/github/NREL/SolTrace?branch=coveralls)
